...
<body data-bs-spy="scroll" data-bs-target="#header-nav" tabindex="0">
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light container-fluid py-3 position-fixed ">
        <div class="container">
          <a class="navbar-brand" href="index.php"><img src="images/silupkom.png" alt="logo" ></a>
    ...
    <section id="hero" class="position-relative overflow-hidden py-4" style="background: url(images/kam22.jpeg);">
    ...
    <section id="about">
        <div class="container py-5">
            <div class="row align-items-center py-5">
                <div class=" col-md-6 ps-md-5"><img src="images/kami.jpeg" alt="image" width="525" height="364" class="img-fluid"></div>
                    ...
                    <h2 class="accordion-header" id="panelsStayOpen-headingThree">
                        <button class="accordion-button fs-5 collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            aria-controls="panelsStayOpen-collapseThree">
                             APA SAJA PERATURAN DI LAB UPT KOMPUTER ?
                        </button>
                    </h2>
